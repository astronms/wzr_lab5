    ...
    public void action() {
      switch (step) {
        ...
        case NegotiateStep: {
          ...
          final int acceptanceThreshold = 0;
          ...
          if (negotiationSucceeded) {
            ...
            if (proposalCounter >= proposalLimit) {
              System.out.println(
                      " Agent-kupiec" + getAID().getName() + " Nie udalo sie wynegocjowac akceptowalnej oferty, ostatnia: " + lastOffer);
              step = OutOfBusiness;
              break;
            }
          }
          ...
          System.out.println(" Kupiec" + getAID().getName() + " proponuje: " + offer + " numer oferty: " + proposalCounter);
